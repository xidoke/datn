...
export const GanttSidebarHeader: FC = () => (
  <div
    className="sticky top-0 z-10 flex shrink-0 items-end justify-between gap-2.5 border-b border-border/50 bg-backdrop/90 p-2.5 text-xs font-medium text-muted-foreground backdrop-blur-sm"
    style={{ height: "var(--gantt-header-height)" }}
  >
